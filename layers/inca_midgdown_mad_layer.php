...
class IncaMidgdownMadLayer extends IncaLayer{
	...
	public function __construct(){
            ...
            $thumb_output_path = "midgdown_mad_thumb.png";
            $date = new DateTime();
            ...
            $curl_url = "https://geoserver.usanpn.org/geoserver/wms?service=WMS&request=GetMap&bbox=-14000000,2700000,-7000000,6450000&srs=EPSG:3857&layers=inca:midgdown_mad_nad83_02deg&width=1500&height=800&format=image/png&transparent=true";
