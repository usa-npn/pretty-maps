...
class SpottedLanternFlyAdultLayer extends BasicLayer{
	
    public function __construct($long_forecast=false){
        $title = "Spotted Lantern Fly Adult Forecast";
        ...
        $output_path = "slf_adult.png";        
        $curl_url = "http://geoserver.usanpn.org/geoserver/wms?service=WMS&request=GetMap&bbox=-14000000,2700000,-7000000,6450000&srs=EPSG:3857&layers=gdd:slf_adult&width=1500&height=800&ENV=doy:".(date('z')+1)."&time="  . date_format(new DateTime(), "Y-m-d") . "&format=image/png&transparent=true";
        ...
        $this->subtitle = "Threshold: 1934 GDD(F), Base: 50F, Start: Jan 1";
