...
class EmeraldAshBorerAdultLayer extends BasicLayer{
    ...
    public function __construct($long_forecast=false){
        ...
        $curl_url = "http://geoserver.usanpn.org/geoserver/wms?service=WMS&request=GetMap&bbox=-125.020833333,24.520833333,-66.520833333,49.395833332&srs=EPSG:3857&layers=gdd:eab_adult&width=768&height=330&ENV=doy:220&time="  . date_format(new DateTime(), "Y-m-d") . "&format=image/png&transparent=true";
